...
INSERT INTO `user` (`id`, `email`, `name`, `password`, `phone`, `username`) VALUES (1, NULL, '管理员', '$2a$10$nVYak7TjO3td5Py/cYcDWOiAQVS8r6f/uN.ErMBn/P5oM/ld61Z9G', NULL, 'root');
...
DELETE FROM `authority_seq` WHERE `next_val`=1;
INSERT INTO `authority_seq` (`next_val`) VALUES (3);

DELETE FROM `user_seq` WHERE `next_val`=1;
